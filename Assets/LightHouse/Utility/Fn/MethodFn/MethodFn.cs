namespace LightHouse.Fn
{
    ...
    [Serializable]
    public class MethodFn<T1, TResult> : IFn<ITuple<T1>, TResult>
    {
        public MethodInfo MethodInfo;
    ...
    [Serializable]
    public class MethodFn<T1, T2, TResult> : IFn<ITuple<T1, T2>, TResult>
    {
        public MethodInfo MethodInfo;
    ...
    [Serializable]
    public class MethodFn<T1, T2, T3, TResult> : IFn<ITuple<T1, T2, T3>, TResult>
    {
        public MethodInfo MethodInfo;
    ...
    [Serializable]
    public class MethodFn<T1, T2, T3, T4, TResult> : IFn<ITuple<T1, T2, T3, T4>, TResult>
    {
        public MethodInfo MethodInfo;
    ...
    [Serializable]
    public class MethodFn<T1, T2, T3, T4, T5, TResult> : IFn<ITuple<T1, T2, T3, T4, T5>, TResult>
    {
        public MethodInfo MethodInfo;
    ...
    [Serializable]
    public class MethodFn<T1, T2, T3, T4, T5, T6, TResult> : IFn<ITuple<T1, T2, T3, T4, T5, T6>, TResult>
    {
        public MethodInfo MethodInfo;
    ...
    [Serializable]
    public class MethodFn<T1, T2, T3, T4, T5, T6, T7, TResult> : IFn<ITuple<T1, T2, T3, T4, T5, T6, T7>, TResult>
    {
        public MethodInfo MethodInfo;
    ...
    [Serializable]
    public class MethodFn<T1, T2, T3, T4, T5, T6, T7, T8, TResult> : IFn<ITuple<T1, T2, T3, T4, T5, T6, T7, T8>, TResult>
    {
        public MethodInfo MethodInfo;
